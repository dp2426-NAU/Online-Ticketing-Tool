                ...
                <Item style={{ marginLeft: "-100px", marginTop: "15px" }}>
                  <div className={styles.navbarUpperSectionItems}>
                    <ul>
                      ...
                      <li>
                        <HeaderSvg
                          path={Paths.questionIcon}
                          styles={styles.questionIcon}
                        />
                      </li>
                      <li className={styles.propertyList}></li>
                      {
              ...
              <Grid item xs={1.5} style={{ marginTop: -10, marginLeft: -15 }}>
                <Item>
                  <Link to="/" style={{ textDecoration: "none" }}>
                    ...
                    >
                      <HeaderSvg
                        path={Paths.staysIcon}
                        styles={styles.svgIcons}
                      />
              ...
              <Grid item xs={1.5} style={{ marginTop: -10, marginLeft: -15 }}>
                <Item>
                  <Link to="/rentals" style={{ textDecoration: "none" }}>
                    ...
                    >
                      <HeaderSvg
                        path={Paths.rentalIcon}
                        styles={styles.svgIcons}
                      />
                      <p className={styles.text}>Rentals</p>
                    </StyledButton>
                  </Link>
                </Item>
              </Grid>
              <Grid item xs={1.5} style={{ marginTop: -10, marginLeft: -10 }}>
                <Item>
                  <Link to="/attractions" style={{ textDecoration: "none" }}>
                    ...
                    >
                      <HeaderSvg
                        path={Paths.attractionIcon}
                        styles={styles.svgIcons}
                      />
                      <p className={styles.text}>Attractions</p>
                    </StyledButton>
                  </Link>
                </Item>
              </Grid>
              <Grid item xs={1.5} style={{ marginTop: -10, marginLeft: -5 }}>
                <Item>
                  <Link to="/" style={{ textDecoration: "none" }}>
                    ...
                    >
                      <HeaderSvg
                        path={Paths.flightHotelIcon}
                        styles={styles.svgIcons}
                      />
                      <p className={styles.text}>Flight+Hotel</p>
                    </StyledButton>
                  </Link>
                </Item>
              </Grid>
                  ...
                  <Link to="/" style={{ textDecoration: "none" }}>
                    ...
                    >
                      <HeaderSvg
                        ...
                        styles={styles.svgIcons}
                      />
                      <p className={styles.text}>Taxis</p>
                    </StyledButton>
                  </Link>
                </Item>
              </Grid>
